...
ES=$PROJ_DIR/node1
$ES/bin/elasticsearch -Des.pidfile=$ES/bin/es1.pid -Des.config=$ES/config/elasticsearch.yml -Djava.net.preferIPv4Stack=true -Des.max-open-files=true > /dev/null 2>&1 &
