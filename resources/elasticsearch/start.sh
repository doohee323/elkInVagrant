...
$ES/bin/elasticsearch -Des.pidfile=$ES/bin/es.pid -Des.config=$ES/config/elasticsearch.yml -Djava.net.preferIPv4Stack=true -Des.max-open-files=true > /dev/null 2>&1 &
